...
return (
    ...
    <section id="feedback" className="py-16 px-6 bg-black text-white">
    <div className="max-w-[90%] mx-auto pt-[30px]">
        ...
        <CardHeader>
            <CardTitle className="font-orbitron text-4xl text-golden text-center">
        ...
        <CardContent>
            ...
            <Button
                type="submit"
                className="w-full bg-golden text-black hover:bg-golden/90 font-rajdhani font-semibold text-lg py-6"
            >
                Submit Feedback
            </Button>
            </form>
